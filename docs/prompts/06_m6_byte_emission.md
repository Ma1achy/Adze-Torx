...
```text
Continue Adze-T with milestone M6 only.
...
- docs/TESTING.md
- docs/milestones/M6_BYTE_EMISSION.md
...
Implement only the deliverables and tests required by docs/milestones/M6_BYTE_EMISSION.md.
