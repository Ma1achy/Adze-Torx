...
```text
Continue Adze-T with milestone M7 only.
...
- docs/TESTING.md
- docs/milestones/M7_REFINEMENT_R.md
...
Implement only the deliverables and tests required by docs/milestones/M7_REFINEMENT_R.md.
