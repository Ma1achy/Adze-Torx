...
```text
Continue Adze-T with milestone M2 only.
...
- docs/TESTING.md
- docs/milestones/M2_DIRECT_CARRIER.md
...
Implement only the deliverables and tests required by docs/milestones/M2_DIRECT_CARRIER.md.
