...
```text
Continue Adze-T with milestone M8 only.
...
- docs/TESTING.md
- docs/milestones/M8_ADAPTIVE_COMPUTE.md
...
Implement only the deliverables and tests required by docs/milestones/M8_ADAPTIVE_COMPUTE.md.
