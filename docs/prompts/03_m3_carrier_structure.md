...
```text
Continue Adze-T with milestone M3 only.
...
- docs/TESTING.md
- docs/milestones/M3_CARRIER_STRUCTURE.md
...
Implement only the deliverables and tests required by docs/milestones/M3_CARRIER_STRUCTURE.md.
