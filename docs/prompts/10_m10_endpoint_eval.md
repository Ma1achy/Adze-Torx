...
```text
Continue Adze-T with milestone M10 only.
...
- docs/TESTING.md
- docs/milestones/M10_ENDPOINT_EVAL.md
...
Implement only the deliverables and tests required by docs/milestones/M10_ENDPOINT_EVAL.md.
