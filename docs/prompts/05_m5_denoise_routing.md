...
```text
Continue Adze-T with milestone M5 only.
...
- docs/TESTING.md
- docs/milestones/M5_DENOISE_ROUTING.md
...
Implement only the deliverables and tests required by docs/milestones/M5_DENOISE_ROUTING.md.
