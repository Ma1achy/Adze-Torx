...
```text
Continue Adze-T with milestone M11 only.
...
- docs/TESTING.md
- docs/milestones/M11_HARDWARE_OPTIONAL.md
...
Implement only the deliverables and tests required by docs/milestones/M11_HARDWARE_OPTIONAL.md.
