...
```text
Continue Adze-T with milestone M4 only.
...
- docs/TESTING.md
- docs/milestones/M4_RECURRENT_CORE_Q.md
...
Implement only the deliverables and tests required by docs/milestones/M4_RECURRENT_CORE_Q.md.
